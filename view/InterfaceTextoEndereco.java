...
public class InterfaceTextoEndereco {
	...
	public Endereco cadastrarEndereco() {
	    ...
	    System.out.print("os dados cidade"+cidade +", bairro" + bairro +", numero da casa"+numeroDaCasa+" est�o coretos?");
	    System.out.println("Se est�o coerretos escreva sim ou n�o.");
		do {
